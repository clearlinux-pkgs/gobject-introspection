...
Source0  : https://download.gnome.org/sources/gobject-introspection/1.84/gobject-introspection-1.84.0.tar.xz
...
%prep
%setup -q -n gobject-introspection-1.84.0
cd %{_builddir}/gobject-introspection-1.84.0
pushd ..
cp -a gobject-introspection-1.84.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742589460
...
cp %{_builddir}/gobject-introspection-%{version}/gobject-introspection-tests/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/gobject-introspection/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0 || :
cp %{_builddir}/gobject-introspection-%{version}/gobject-introspection-tests/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/gobject-introspection/3cb34cfc72e87654683f2894299adf912d14b284 || :
cp %{_builddir}/gobject-introspection-%{version}/gobject-introspection-tests/LICENSES/MIT.txt %{buildroot}/usr/share/package-licenses/gobject-introspection/adadb67a9875aeeac285309f1eab6e47d9ee08a7 || :
GOAMD64=v3
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/gobject-introspection/giscanner/_giscanner.cpython-313-x86_64-linux-gnu.so
/V3/usr/lib64/libgirepository-1.0.so.1.0.0
/usr/lib64/gobject-introspection/giscanner/__init__.py
/usr/lib64/gobject-introspection/giscanner/_giscanner.cpython-313-x86_64-linux-gnu.so
...
/usr/share/package-licenses/gobject-introspection/3cb34cfc72e87654683f2894299adf912d14b284
...
/usr/share/package-licenses/gobject-introspection/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
/usr/share/package-licenses/gobject-introspection/adadb67a9875aeeac285309f1eab6e47d9ee08a7
