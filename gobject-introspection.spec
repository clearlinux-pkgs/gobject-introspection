...
%prep
%setup -q -n gobject-introspection-1.82.0
cd %{_builddir}/gobject-introspection-1.82.0
pushd ..
cp -a gobject-introspection-1.82.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726781815
...
cp %{_builddir}/gobject-introspection-%{version}/gobject-introspection-tests/COPYING %{buildroot}/usr/share/package-licenses/gobject-introspection/80fe7119545c554233bbac373a7d8b0104e45cd1 || :
cp %{_builddir}/gobject-introspection-%{version}/gobject-introspection-tests/COPYING.GPL %{buildroot}/usr/share/package-licenses/gobject-introspection/6e0119fb857bc6287be560fecaf4bcd3f28034bf || :
cp %{_builddir}/gobject-introspection-%{version}/gobject-introspection-tests/COPYING.LGPL %{buildroot}/usr/share/package-licenses/gobject-introspection/e963be7b84bc2a5891ab63ff87dc536b7f504695 || :
GOAMD64=v3
