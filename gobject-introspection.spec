...
%prep
%setup -q -n gobject-introspection-1.70.0
cd %{_builddir}/gobject-introspection-1.70.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641542198
...
cp %{_builddir}/gobject-introspection-1.70.0/COPYING %{buildroot}/usr/share/package-licenses/gobject-introspection/80fe7119545c554233bbac373a7d8b0104e45cd1
cp %{_builddir}/gobject-introspection-1.70.0/COPYING.GPL %{buildroot}/usr/share/package-licenses/gobject-introspection/dfac199a7539a404407098a2541b9482279f690d
cp %{_builddir}/gobject-introspection-1.70.0/COPYING.LGPL %{buildroot}/usr/share/package-licenses/gobject-introspection/bf50bac24e7ec325dbb09c6b6c4dcc88a7d79e8f
