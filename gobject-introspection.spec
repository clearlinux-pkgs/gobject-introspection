...
Source0  : https://download.gnome.org/sources/gobject-introspection/1.80/gobject-introspection-1.80.1.tar.xz
...
Patch1: backport-gis-pybuild-fix.patch
...
%prep
%setup -q -n gobject-introspection-1.80.1
cd %{_builddir}/gobject-introspection-1.80.1
%patch -P 1 -p1
pushd ..
cp -a gobject-introspection-1.80.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725470148
