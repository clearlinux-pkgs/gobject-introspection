...
Source0  : https://download.gnome.org/sources/gobject-introspection/1.76/gobject-introspection-1.76.0.tar.xz
...
%prep
%setup -q -n gobject-introspection-1.76.0
cd %{_builddir}/gobject-introspection-1.76.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678895527
