...
Version  : 1.60.2
Release  : 30
URL      : https://github.com/GNOME/gobject-introspection/archive/1.60.2/gobject-introspection-1.60.2.tar.gz
Source0  : https://github.com/GNOME/gobject-introspection/archive/1.60.2/gobject-introspection-1.60.2.tar.gz
...
%prep
%setup -q -n gobject-introspection-1.60.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1560706578
export AR=gcc-ar
