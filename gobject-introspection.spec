...
Source0  : https://download.gnome.org/sources/gobject-introspection/1.72/gobject-introspection-1.72.0.tar.xz
...
%prep
%setup -q -n gobject-introspection-1.72.0
cd %{_builddir}/gobject-introspection-1.72.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647725161
...
cp %{_builddir}/gobject-introspection-1.72.0/COPYING %{buildroot}/usr/share/package-licenses/gobject-introspection/80fe7119545c554233bbac373a7d8b0104e45cd1
